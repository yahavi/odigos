  ...
  <Step title="Set OIDC variables">
    ...
    <Tabs>
      ...
      <Tab title="Helm">
        ...
        ```bash
        helm repo update
        helm upgrade odigos oci://odigosdemo.jfrog.io/helmoci/odigos --namespace odigos-system --set ui.oidcTenantUrl=<value> --set ui.oidcClientId=<value> --set ui.oidcClientSecret=<value>
        ```
      </Tab>
    </Tabs>
  ...
  <Step title="Set UI remote URL (optional)">
    ...
    <Tabs>
      ...
      <Tab title="Helm">
        ...
        ```bash
        helm repo update
        helm upgrade odigos oci://odigosdemo.jfrog.io/helmoci/odigos --namespace odigos-system --set ui.uiRemoteUrl=<value>
        ```
      </Tab>
    </Tabs>
