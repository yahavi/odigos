...
```shell
helm install odigos oci://odigosdemo.jfrog.io/helmoci/odigos --set ignoreNamespace=<namespace1>,<namespace2>
```
...
<Tabs>
  ...
  <Tab title="Helm Chart">
     ```shell
     helm install odigos oci://odigosdemo.jfrog.io/helmoci/odigos --set ignoreContainer=<container1>,<container2>
     ```
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Helm Chart">
     ...
     ```shell
     helm install odigos oci://odigosdemo.jfrog.io/helmoci/odigos --set odiglet.customContainerRuntimeSocketPath=<unix socket path>
     ```
  </Tab>
</Tabs>
